 ...
 *
 * @returns The core table name (e.g., "pilotspan-core-dev")
 ...
 *
 * @returns The base table name (e.g., "pilotspan-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "pilotspan-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "pilotspan-app-realtime-dev")
